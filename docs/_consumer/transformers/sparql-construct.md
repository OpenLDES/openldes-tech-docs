...
<b>LDIO Component Name:</b> <i>`Ldio:SparqlConstructTransformer`</i> see [reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/ldio/ldio-transformers/ldio-sparql-construct) <br>
<b>Apache Nifi Component Name:</b> <i>`SPARQL Interactions Processors`</i> see [reference guide](https://s01.oss.sonatype.org/#nexus-search;gav~org.openldes.ldi.nifi~sparql-interactions-processor~~~~kw,versionexpand)
