...
<b>LDIO Component Name:</b> <i>`Ldio:AzureBlobOut`</i> see [reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/ldio/ldio-outputs/ldio-console-out) <br>
