...
<b>LDIO Component Name:</b> <i>`Ldio:HttpOut`</i> see [reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/ldio/ldio-outputs/ldio-http-out) <br>
