...
<b>LDIO Component Name:</b> <i>`Ldio:RepositoryMaterialiser`</i> see [reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/ldio/ldio-outputs/ldio-repository-materialiser) <br>
<b>Apache Nifi Component Name:</b> <i>`RepositoryMaterialiser` </i> see [reference guide](https://s01.oss.sonatype.org/#nexus-search;gav~org.openldes.ldi.nifi~nifi-rdf4j-repository-materialisation-processor~~~~kw,versionexpand)
