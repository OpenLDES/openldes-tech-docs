...
<b>LDIO Component Name:</b> <i>`Ldio:LdioHttpIn`</i> see [reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/ldio/ldio-inputs/ldio-http-in) <br>
