...
<b>LDIO Pipeline</b> <i></i> see [reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/) <br>
<b>Apache Nifi Component Name:</b> <i>``</i> see [Apache Nifi reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/ldi-nifi/index)
...
<p align="center"><img src="https://openldes.org/assets/images/LDES%20server.png" width="60%" text-align="center"></p>
...
More information on the HTTP ingestion can be found [here](https://openldes.github.io/LDESServer/latest/ingest/http).
...
More information on how to provide an RDF file, containing a SHACL shape, to the LDES server can be found [here](https://openldes.github.io/LDESServer/latest).
...
<p align="center"><img src="https://openldes.org/assets/images/fragmentation.png" width="60%" text-align="center"></p>
...
<p align="center"><img src="https://openldes.org/assets/images/temporal.png" width="60%" text-align="center"></p>
...
<p align="center"><img src="https://openldes.org/assets/images/retention_policy.png" width="60%" text-align="center"></p>
...
SHACL (Shapes Constraint Language) is a language used to validate RDF graphs against a set of conditions provided as shapes and other constructs in an RDF graph. The LDES Server facilitates hosting a SHACL shape describing the members in the LDES. Through configuration, it is possible to [reference an existing SHACL shape](https://openldes.github.io/LDESServer/latest/configuration/event-stream#configuring-a-shacl-shape) via an URL or to provide a [static file](https://openldes.github.io/LDESServer/latest/configuration/event-stream#configuring-a-shacl-shape) with an RDF description of the SHACL shape.
...
More information on configuring DCAT on the LDES Server can be found [here](https://openldes.github.io/LDESServer/latest/configuration/dcat).
