...
<b>LDIO Component Name:</b> <i>`Ldio:NgsiV2ToLdAdapter`</i> see [reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/ldio/ldio-adapters/ldio-ngsiv2-to-ld) <br>
