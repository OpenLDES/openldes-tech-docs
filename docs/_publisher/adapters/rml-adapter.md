...
<b>LDIO Component Name:</b> <i>`Ldio:RmlAdapter`</i> see [reference guide](https://openldes.github.io/Linked-Data-Interactions/latest/ldio/ldio-adapters/ldio-rml-adapter) <br>
