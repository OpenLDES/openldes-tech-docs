...
<b>Apache Nifi Component Name:</b> <i>`SPARQL Interactions Processors`</i> see [reference guide](https://s01.oss.sonatype.org/#nexus-search;gav~org.openldes.ldi.nifi~sparql-interactions-processor)
