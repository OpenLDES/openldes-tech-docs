...
<b>Apache Nifi Component Name:</b> <i>`RepositoryMaterialiser` </i> see [reference guide](https://s01.oss.sonatype.org/#nexus-search;gav~org.openldes.ldi.nifi~nifi-rdf4j-repository-materialisation-processor)
